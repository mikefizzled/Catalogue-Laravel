<x-public-app-layout>
  <meta name="viewport" content="width=device-width, initial-scale=1" />
    ...
    <div class="text-white text-center md:text-left">
      ...
      <!-- Section 2 -->
      <section class="relative h-[65vh] overflow-hidden group">
        <img src="{{ asset('kingfisher-3.jpg') }}" alt="Kingfisher sat above the water" class="w-full h-full object-cover object-[8%] md:object-center transition-transform duration-[5s] group-hover:scale-105">
      ...
      <!-- Section 3 -->
      <section class="relative h-[65vh] overflow-hidden group">
        <img src="{{ asset('starling-2.jpg') }}" alt="Starling sat in a cherry tree" class="w-full h-full object-cover object-[92%] md:object-center transition-transform duration-[5s] group-hover:scale-105">
        <div class="absolute inset-0 bg-black opacity-10"></div>
        <div class="absolute left-0 top-0 w-full md:inset-y-0 md:left-0 md:w-2/3 md:flex md:items-center">
          <div class="bg-black bg-opacity-70 p-4">
      ...
      <!-- Section 4 -->
      <section class="relative h-[65vh] overflow-hidden group">
        <img src="{{ asset('blackbird-2.jpg') }}" alt="A Blackbird looking out from a log" class="w-full h-full  object-cover object-[15%_45%] md:object-center transition-transform duration-[5s] group-hover:scale-105">

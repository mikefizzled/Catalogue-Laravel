...
class FileHelper
{
    ...
    /**
     * Collect JPEG metadata in JSON array. Hardcoded for now to match my camera, needs expanding.
     *
     ...
     * Calls the local cwebp and jpegoptim compression tools. Not installed on server.
     */
     ...
     * Workflow isn't tested to see if it works as intended.
     */
